        ...
        >
            ...
            <nav className="flex-1 space-y-1 text-sm px-1">
                ...
                <div className={`submenu ${isHistoriOpen ? 'block' : 'hidden'} space-y-1 pl-6 pt-1`}>
                    ...
                    <NavLink to="/dashboard/histori/histori_pinjaman" onClick={handleLinkClick} className={({ isActive }) => `flex items-center space-x-2 py-2 px-3 rounded-lg transition duration-150 ${isActive ? 'bg-blue-50 text-blue-900 font-semibold' : 'text-gray-700 hover:bg-gray-100'}`}><span>Pinjaman</span></NavLink>
                </div>
